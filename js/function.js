...
! function (e) {
    ...
    SEMICOLON.initialize = {
        ...
        goToTop: function () {
            var t = Y.attr("data-speed"),
                a = Y.attr("data-easing");
            t || (t = 700), a || (a = "easeOutQuad"), Y.click(function () {
        ...
        goToTopScroll: function () {
            ...
            return i || (i = 450), "true" != e && (a.hasClass("device-xs") || a.hasClass("device-xxs")) ? !0 : void(t.scrollTop() > Number(i) ? (Y.fadeIn(), a.addClass("gototop-active")) : (Y.fadeOut(), a.removeClass("gototop-active")))
        },
        fullScreen: function () {
        ...
        maxHeight: function () {
            if (Q.length > 0) {
                if (Q.hasClass("customjs")) return !0;
                Q.each(function () {
                    var t = e(this);
        ...
        superfish: function () {
            return (a.hasClass("device-lg") || a.hasClass("device-md")) && (e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "block"), SEMICOLON.header.menuInvert(), e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "")), e().superfish ? (e("body:not(.side-header) #primary-menu:not(.on-click) > ul, body:not(.side-header) #primary-menu:not(.on-click) > div > ul:not(.dropdown-menu), .top-links:not(.on-click) > ul").superfish({
            ...
            }), void e("body.side-header #primary-menu:not(.on-click) > ul").superfish({
                popUpSelector: "ul",
                delay: 250,
                speed: 350,
                animation: {
        ...
        menufunctions: function () {
            e("#primary-menu ul li:has(ul)").addClass("sub-menu"), e(".top-links ul li:has(ul) > a, #primary-menu.with-arrows > ul > li:has(ul) > a > div, #primary-menu.with-arrows > div > ul > li:has(ul) > a > div, #page-menu nav ul li:has(ul) > a > div").append('<i class="icon-angle-down"></i>'), e(".top-links > ul").addClass("clearfix"), (a.hasClass("device-lg") || a.hasClass("device-md")) && (e("#primary-menu.sub-title > ul > li").hover(function () {
                ...
                e(this).parents(".sub-menu").siblings().find("ul,.mega-menu-content").removeClass("show"), e(this).parent("li").children("ul,.mega-menu-content").toggleClass("show"), t.preventDefault()
        ...
        topsearch: function () {
            e(document).on("click", function (t) {
                e(t.target).closest("#top-search").length || a.toggleClass("top-search-open", !1), e(t.target).closest("#top-cart").length || A.toggleClass("top-cart-open", !1), e(t.target).closest("#page-menu").length || w.toggleClass("pagemenu-active", !1), e(t.target).closest("#side-panel").length || a.toggleClass("side-panel-open", !1), e(t.target).closest("#primary-menu").length || e("#primary-menu.on-click > ul").find(".show").removeClass("show"), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > ul").length || e("#primary-menu.mobile-menu-off-canvas > ul").toggleClass("show", !1), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > div > ul").length || e("#primary-menu.mobile-menu-off-canvas > div > ul").toggleClass("show", !1)
        ...
        sliderRun: function () {
            ...
            if (k.hasClass("swiper_wrapper")) {
                ...
                L = new Swiper(t.find(".swiper-parent"), {
                    ...
                    nextButton: f,
                    onInit: function (a) {
                        SEMICOLON.slider.sliderParallaxDimensions(), t.find(".yt-bg-player").removeClass("customjs"), e(".swiper-slide-active [data-caption-animate]").each(function () {
                            var t = e(this),
        ...
        closeItem: function () {
            j && j.height() > 32 && (D.fadeIn(), j.find("#portfolio-ajax-single").fadeOut("600", function () {
                e(this).remove()
            }), j.removeClass("portfolio-ajax-opened"))
        },
        openItem: function () {
            var t = j.find("img").length,
                a = 0;
            if (t > 0) j.find("img").on("load", function () {
                ...
                if (t === a) {
                    P.css({
                        display: "block"
                    }), j.addClass("portfolio-ajax-opened"), D.fadeOut();
                    setTimeout(function () {
        ...
        init: function () {
            SEMICOLON.widget.animations(), SEMICOLON.widget.tabs(), SEMICOLON.widget.tabsJustify(), SEMICOLON.widget.tabsResponsive(), SEMICOLON.widget.tabsResponsiveResize(), SEMICOLON.widget.toggles(), SEMICOLON.widget.accordions(), SEMICOLON.widget.counter(), SEMICOLON.widget.roundedSkill(), SEMICOLON.widget.progress(), SEMICOLON.widget.twitterFeed(), SEMICOLON.widget.flickrFeed(), SEMICOLON.widget.instagramPhotos("20524966.5125dda.b5456638b95c4acd8ed9cc82f897cd10", "5125dda742b5492488c790c2a440ace3"), SEMICOLON.widget.dribbbleShots("01530280af335d298e756ed8ef786c8c4e92a50b88e53a185531b1a639e768b8"), SEMICOLON.widget.navTree(), SEMICOLON.widget.textRotater(), SEMICOLON.widget.carousel(), SEMICOLON.widget.linkScroll(), SEMICOLON.widget.contactForm(), SEMICOLON.widget.subscription(), SEMICOLON.widget.quickContact(), SEMICOLON.widget.stickySidebar(), SEMICOLON.widget.cookieNotify(), SEMICOLON.widget.extras()
        },
        parallax: function () {
        ...
        tabsJustify: function () {
            if (e("body").hasClass("device-xxs") || e("body").hasClass("device-xs")) e(".tabs.tabs-justify").find(".tab-nav > li").css({
                ...
                var t = e(".tabs.tabs-justify:not(.customjs)");
                t.length > 0 && t.each(function () {
                    var t = e(this),
                        a = t.find(".tab-nav > li"),
                        i = a.length,
        ...
        tabsResponsive: function () {
            if (!e().tabs) return console.log("tabs: Tabs not Defined."), !0;
            var t = e(".tabs.tabs-responsive:not(.customjs)");
                ...
                s ? s -= 1 : s = 0, t.find(".acc_content").hide(), "closed" != i && t.find(".acctitle:eq(" + Number(s) + ")").addClass("acctitlec").next().show(), t.find(".acctitle").click(function () {
                    if (e(this).next().is(":hidden")) {
                        ...
                        e(this).toggleClass("acctitlec").next().slideDown("normal", function () {
                            (a.hasClass("device-xs") || a.hasClass("device-xxs")) && e("html,body").stop(!0).animate({
    ...
    var t = e(window),
        ...
        j = e("#portfolio-ajax-wrap"),
        P = e("#portfolio-ajax-container"),
